...
class HighSpeedMission(Node):
    def __init__(self):
        super().__init__('high_speed_mission')

        self.waypoints = [
            [0.0, 0.0, -5.0],  # Takeoff point
            [30.0, 0.0, -5.0],  # Circle start point
        ]
        ...
        self.get_logger().info("High-Speed Mission Node Started")
