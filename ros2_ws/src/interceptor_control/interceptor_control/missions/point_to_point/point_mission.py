...
from interceptor_control.missions.point_to_point.point_logger import PointLogger
...
class PointMission(Node):
    def __init__(self):
        ...
        result_dir = str(
            Path.home() / "Documents" / "interceptor_drone" / "ros2_ws" / "results"
        )
        self.logger = PointLogger(result_dir)
